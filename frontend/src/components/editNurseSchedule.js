...
export default class editNurseSchedule extends Component {
    ...
    onSubmit = (e) =>{
        ...
        axios.put(`/nurse/update_nurseSchedule/${id}`,data).then((res) =>{
            if(res.data.success){
                alert("Nurse Schedule Updated")
                this.setState(
                    {
                        wid:"",
                        mid:"",
    ...
    componentDidMount(){
        ...
        axios.get(`/wardnurse/${id}`).then((res) =>{
            if(res.data.success){
                this.setState({
                    wid:res.data.nurses.wid,
                    mid:res.data.nurses.mid,
                    name:res.data.nurses.name,
                    monday:res.data.nurses.monday,
                    tuesday:res.data.nurses.tuesday,
                    wednesday:res.data.nurses.wednesday,
                    thursday:res.data.nurses.thursday,
                    friday:res.data.nurses.friday,
                    saturday:res.data.nurses.saturday,
                    sunday:res.data.nurses.sunday
    ...
    render() {
        return (
            <div>
                 <NavBar/>
            <div className="col-md-4 mt-3 mx-auto" style={{ height:'800px'}}>
               
               <h1 className="h3 mb-3 font-weight-normal">Edit Nurse Schedule Details</h1><br/>
